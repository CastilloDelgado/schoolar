...
const FormularioMaestro = (props) => {
  const { values, maestro_para_actualizar, fetching } = props;
  ...
  for (const value in values) {
    if (values[value].id === maestro_para_actualizar) {
      ...
      {!fetching ? (
        <form onSubmit={onSubmit}>
          <div className="alert alert-primary" role="alert">
            Completa el formulario y haz click en el boton de Crear Maestro.
          </div>
          <div className="row">
